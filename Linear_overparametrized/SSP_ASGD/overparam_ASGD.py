...
<<<<<<< HEAD:Linear_overparametrized/SSP_ASGD/overparam_ASGD.py
...
class ParameterServerStatus(Enum):
    ...
    REJECTED = 1
    SHUTDOWN = 2
>>>>>>> 3f791901c8a1886ae632d3d98846fbacbf58317b:Linear_overparametrized/SSP_ASGD/testing_overparam_ASGD.py
